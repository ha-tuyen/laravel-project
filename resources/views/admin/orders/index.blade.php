                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="code" value="{{Request::get('code')}}" placeholder="Mã đơn hàng">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                          ...
                          @else
                            ...
                            @foreach ($orders as $key => $order)
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.order.detail',[$order->id]) }}">{{ $order->code }}</a></td>
                                    <td>
                                        @if($order->status == 1)
